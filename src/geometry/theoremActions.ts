...
export const theoremActions: Record<string, TheoremActionDefinition> = {
  ...
  createCircleWithTransferredRadius: {
    ...
    inputs: ["sourceLength", "targetStartPoint", "targetLineOrRay"],
    outputs: ["copiedEndpoint", "copiedSegment"],
    dependencies: ["I.2", "I.3"],
    validationFunction: "copiedSegmentEqualsSourceLength",
    logicReplay: [
      "Use I.2 as the justification for carrying a known length.",
      "Choose the target start point and the target line or ray.",
      "The placed endpoint makes the new segment equal to the source length.",
    ],
  ...
  cutOffEqualSegment: {
    ...
    logicReplay: [
      ...
      "Choose the start point on a target line or ray.",
      "Copy Length places the endpoint at the equal distance.",
    ],
